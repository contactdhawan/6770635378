...
caterpillar3 = t.Turtle()
caterpillar3.shape('square')
caterpillar3.color('green')
caterpillar3.penup()
caterpillar3.speed(0)
caterpillar3.hideturtle()
...
def reset_game():
    ...
    caterpillar2.color('blue')
    caterpillar3.hideturtle()
    caterpillar3.setpos(0, 0)
    caterpillar3.setheading(0)
    caterpillar3.shapesize(1, 3, 1)
    caterpillar3.color('green')
...
def start_game():
    ...
    caterpillar3.shapesize(1, caterpillar_length, 1)
    caterpillar3.setheading(180)
    caterpillar3.showturtle()
    ...
    while True:
        ...
        caterpillar3.forward(caterpillar_speed)
        if caterpillar.distance(leaf) < 70 or leaf.distance(caterpillar2) < 70 or caterpillar3.distance(leaf) < 70:
            place_leaf()
...
def caterpillar3_up():
    if caterpillar3.heading() == 0 or caterpillar3.heading() == 180:
        caterpillar3.setheading(90)

def caterpillar3_down():
    if caterpillar3.heading() == 0 or caterpillar3.heading() == 180:
        caterpillar3.setheading(270)

def caterpillar3_left():
    if caterpillar3.heading() == 90 or caterpillar3.heading() == 270:
        caterpillar3.setheading(180)

def caterpillar3_right():
    if caterpillar3.heading() == 90 or caterpillar3.heading() == 270:
        caterpillar3.setheading(0)
...
t.onkey(caterpillar3_up, 'i')
t.onkey(caterpillar3_down, 'k')
t.onkey(caterpillar3_left, 'j')
t.onkey(caterpillar3_right, 'l')
